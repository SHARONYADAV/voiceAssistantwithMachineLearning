...
xtrain,xtest,ytrain,ytest = train_test_split(flat_data,target,test_size=0.3,random_state=10)  #changing random state will make out accuracy change too
...
import pickle
pickle.dump(clf,open('model\\fruitsxyz','wb'))  #new file img_model.p will be made   #wb = writing byte
speak('   Model saved...')
